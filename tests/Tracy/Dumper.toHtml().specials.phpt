...
Assert::match(
	<<<'XX'
		...
		<div><span class="tracy-dump-indent">   </span><span class="tracy-dump-virtual">a</span>: <span class="tracy-dump-number">1</span>
		<span class="tracy-dump-indent">   </span><span class="tracy-dump-virtual">b</span>: <span class="tracy-dump-number">2</span>
		</div></pre>
		XX,
	Dumper::toHtml($obj),
);
